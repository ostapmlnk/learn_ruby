...
#     cd 00_hello
#
# This directory is the starting point for this exercise. It contains a spec file and you'll be adding a ruby_learn file to (eventually) make the specs pass.
#
# ## Run the test
#
#     rake
